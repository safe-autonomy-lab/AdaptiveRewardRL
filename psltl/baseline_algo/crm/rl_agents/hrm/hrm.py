...
def eval_model(Q_options, Q_controller, eval_env, noise_level, env_name, gamma, q_init, eval_nbr = 5):
    ...
    for _ in range(eval_nbr):
        ...
        while not eval_done:
            ...
            a = get_best_action(Q_options,tuple(eval_env.get_option_observation(option_id)), actions,q_init)
    ...
    while step < total_timesteps:
        ...
        while True:
            ...
            if step % eval_freq == 0:
                ...
                print("step: {} and reward: {} and success: {}".format(step, np.mean(temp_eval_reward), np.mean(temp_eval_success)))
