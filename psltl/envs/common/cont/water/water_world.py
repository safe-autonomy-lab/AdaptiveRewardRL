...
class WaterWorld(gym.Env):
    ...
    def reset(self):
        ...
        init_state = tuple(self.get_features())
    ...
    def step(self, action):
        ...
        state = tuple(self.get_features())
        reward = 0 # this reward will not be used
        done = False
        info = {}
    ...
    def load_state(self, filename):
        ...
        if not self.use_velocities:
            ...
            for b in self.balls:
                b.vel = np.array([0.0,0.0], dtype=float)
