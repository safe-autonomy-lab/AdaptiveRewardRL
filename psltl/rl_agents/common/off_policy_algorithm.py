...
from psltl.rl_agents.common.base_class import BaseAlgorithm
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def __init__(
        ...
        # For counter factual experiences
        self.use_cf = use_cf
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            # use counter factual experiences
            if self.use_cf:
                counter_factual_exp = infos[0]["counter_factual_exp"]
                for exp in counter_factual_exp:    
                    imagined_obs, imageind_rewards, imagined_dones = exp
                    self._store_transition(replay_buffer, buffer_actions, [imagined_obs], [imageind_rewards], [imagined_dones], [{}])
